...
// VALIDATORS-AUX
// ----------------------------------------------------------------------------
// v5.01 - ALS@21-10-2015
// ----------------------------------------------------------------------------
// v5.10 - EJR@19-11-2015
// ----------------------------------------------------------------------------
...
define('module/validators/validators-aux', ['module/validators/validators-val'], function() {
    ...
    Module.prototype.addValidator = function(validation, id, message) {
        return this.core.addValidator(validation, id, message);
    }
